...
//                        addrHtml = oldAddrHtml + "," + tProvince + tCity + tArea + tTown;
			...
			function chooseProvince(provinceId) {
				...
				areaTabContainer.eq(1).addClass("curr").show().find("em").html("choose");
			...
			function chooseCity(cityId, cityName) {
				...
				areaTabContainer.eq(2).addClass("curr").show().find("em").html("choose");
				areaTabContainer.eq(3).hide();
				areaContainer.show().html("<div class='iloading'>is loading...</div>");
				townaContainer.hide();
		...
		/*	function chooseArea(areaId, areaName) {
				...
				areaTabContainer.eq(3).addClass("curr").show().find("em").html("choose");
				townaContainer.show().html("<div class='iloading'>is loading...</div>");
